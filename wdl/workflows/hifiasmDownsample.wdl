...
task convertToFastq {
  ...
  command <<<
    ...
    rasusa reads --genome-size ~{genomeSize}g -c ~{coverage} ~{outname}.uniqName.fastq | bgzip > ~{outname}.uniqName.50x_rasusa_downsampled.fastq.gz
